...
class DetailsFrite extends StatefulWidget {
  final Frite frite;
  const DetailsFrite({super.key, required this.frite});

  @override
  State<DetailsFrite> createState() => _DetailsFriteState();
}

class _DetailsFriteState extends State<DetailsFrite> {
  int quantity = 1;
  @override
      ...
      body: Stack(
        children: [
          ...
          Padding(
            ...
            child: Image.asset(
              widget.frite.imagePath, // Image dynamique
              height: 370,
              width: 370,
            ),
          ),
                  ...
                  Row(
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            widget.frite.name, // Nom du burger
                            style: GoogleFonts.varelaRound(
                                fontSize: 18,
                                color: Colors.black,
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                widget
                                    .frite.description, // Description du burger
                                style: GoogleFonts.varelaRound(
                      ...
                      const Spacer(),
                      Text(
                        "\$${(widget.frite.price * quantity).toStringAsFixed(2)}", // Prix du burger
                        style: GoogleFonts.varelaRound(
                            fontSize: 20,
                            color: Colors.black,
                            fontWeight: FontWeight.bold),
